...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn('dropdown-menu__sub-trigger', inset && 'dropdown-menu__sub-trigger--inset', className)}
    {...props}
  >
    {children}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn('dropdown-menu__item', inset && 'dropdown-menu__item--inset', className)}
    {...props}
  />
));
  ...
  >
    <span className="dropdown-menu__checkbox-indicator">
      <DropdownMenuPrimitive.ItemIndicator>
        <CheckIcon className="dropdown-menu__checkbox-icon" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.CheckboxItem>
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span className="dropdown-menu__radio-indicator">
      <DropdownMenuPrimitive.ItemIndicator>
        <span className="dropdown-menu__radio-dot" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn('dropdown-menu__label', inset && 'dropdown-menu__label--inset', className)}
    {...props}
  />
));
...
const DropdownMenuShortcut: React.FC<React.HTMLAttributes<HTMLSpanElement>> = ({
  ...
  return <span className={cn('dropdown-menu__shortcut', className)} {...props} />;
};
